...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const resp = await fetch(`${REGISTRY}/api/v1/auth/login`, {
        method: "POST",
  ...
  return (
    <div className="max-w-md mx-auto mt-16">
      ...
      <p className="mb-8 text-gray-500">Sign in to manage your hosted agents.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            ...
            <a href="/forgot-password" className="text-xs text-nexus-500 hover:underline">
              Forgot password?
            </a>
          </div>
          <input
      ...
      <p className="mt-6 text-center text-sm text-gray-500">
        ...
        <a href="/signup" className="text-nexus-500 hover:underline font-medium">
          Sign up
        </a>
      </p>
    </div>
